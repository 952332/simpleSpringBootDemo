<template>
	<div class="diy_home diy_list diy_public_number_push" id="diy_public_number_push_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x">
					<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/public_number_push/details?public_number_push_id=' + o['public_number_push_id']">
										<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/public_number_push/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/public_number_push/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                <div class="slider" ref="slider">
                    ...
                    <router-link :to="'/public_number_push/details?public_number_push_id=' + o['public_number_push_id']" class="lis_cont">
						                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/public_number_push/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
...
<script>
	export default {
			...
			return {
				...
				totalItems: 3,
						...
						itemList: [
								{
									title: "公众号名称",
									name: "public_number_name",
									type: "文本",
									is_img_list: "0"
								},
								{
									title: "公众号类型",
									name: "public_number_type",
									type: "下拉",
									is_img_list: "0"
								},
								{
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/public_number_push/details?public_number_push_id="+v.public_number_push_id)
			},
